...
<body style="margin: 20px auto;background-color: #f5f5f5;">
    <table align="center" border="0" cellpadding="0" cellspacing="0"
        style="background-color: white; width: 50%; box-shadow: 0px 0px 14px -4px rgba(0, 0, 0, 0.2705882353);-webkit-box-shadow: 0px 0px 14px -4px rgba(0, 0, 0, 0.2705882353);text-align: center;">
        <tbody>
            <tr>
                <td>
{{-- 
                    ...
                    <table class="contant-table" style="" align="center" border="0" cellpadding="0"
                        cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <td class="header-logo" align="center" style="text-align: center;">
                                    <a href="{{ route('home') }}" style="display: block; text-align: center;">
                                        <img src="https://stagging-stylebrix.s3.ap-south-1.amazonaws.com/logo/styleBrix.png" class="main-logo" alt="logo" width="25%">
                                    </a>
                                </td>
                            </tr>
                    ...
                    <table class="button-table" style="margin-top: 27px;" align="center" border="0" cellpadding="0"
                        ...
                        <thead>
                            <tr style="display: block;">
                                <td style="display: block;color: #fff">
                                    <a href="{{ route('reset.password.get', ['email' => $email, 'token' => $token]) }}" style="color: #fff" class="password-button">Set a new password</a>
                                </td>
                            </tr>
                        </thead>
                    </table>
                    ...
                    <table class="text-center footer-table" align="center" border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            <td>
                                    ...
                                    <tr>
                                        <td>
                                            <h4 style="font-size: 19px; font-weight: 700; margin: 0;">Shop For <span
                                                    class="theme-color">StyleBrix</span></h4>
                                        </td>
                                    </tr>
                                </table>
                                <table border="0" cellpadding="0" cellspacing="0" class="footer-social-icon text-center"
                                ...
                                letter-spacing:1px; font-weight: 500;">If you have questions regarding your Data, please visit our Privacy Policy
                                            </h5>
