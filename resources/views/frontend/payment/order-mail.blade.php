...
<body style="margin: 20px auto;background-color: #f5f5f5;">
    @php
        $order = App\Models\Order::where('user_id',auth()->user()->id)->latest()->first();
        $OrderProduct = App\Models\OrderedProduct::where('order_id', $order->id)->orderBy('id', 'asc')->get();
    @endphp
    <table align="center" border="0" cellpadding="0" cellspacing="0"
        style="background-color: #fff;width: 50%; box-shadow: 0px 0px 14px -4px rgba(0, 0, 0, 0.2705882353);-webkit-box-shadow: 0px 0px 14px -4px rgba(0, 0, 0, 0.2705882353);">
        <tbody>
            <tr>
                <td>
                    <table class="header-table" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr class="header"
                            style="background-color: #f7f7f7;align-items: center;width: 100%;">
                            <td class="header-logo" style="padding: 10px 32px;text-align: center;">
                                <a href="{{ route('home') }}" style="display: block; text-align: center;">
                                    <img src="https://stagging-stylebrix.s3.ap-south-1.amazonaws.com/logo/styleBrix.png" class="main-logo" alt="logo" width="15%">
                                </a>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table style="padding: 27px;" align="center" border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            <td style="text-align: center;">
                                <img src="https://stagging-stylebrix.s3.ap-south-1.amazonaws.com/logo/order-success-poster.png" alt="" style="width: 100%; height: 100%;">
                            </td>
                        </tr>
                    </table>
                    ...
                    <table class="dilivery-table" align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                        ...
                        <tbody>
                            <tr>
                                <td
                                    style="text-align: center;padding-right: 28px;border-right: 2px solid rgba(217, 217, 217, 0.5);width:50%;">
                                    <div class="title title-2" style="text-align: center;">
                                        ...
                                        <p
                                            ...
                                            {{ $order->shipping_address }}, {{ $order->shipping_landmark }}, {{ $order->shipping_city }}, {{ $order->shipping_state }}, {{ $order->shipping_country }}, {{ $order->shipping_country }}, {{ $order->shipping_pincode }}.</p>
                                    </div>
                                </td>

                                <td style="text-align: center;padding-left: 32px;width:50%;">
                                    <div class="title title-2" style="text-align: center;">
                                        <h2 style="font-size: 16px;font-weight: 700;margin: 0 0 12px;">Thanks For your
                                            Order</h2>
                                        <p
                                            ...
                                            @foreach ($OrderProduct as $OrderProducts)
                                                <tr>
                                                    <td
                                                        ...
                                                        <img src="{{ $OrderProducts->product->thumbnail }}" alt="" style="width: 80%;">
                                                    </td>
                                                    <td
                                                        style="padding: 28px 0;border-bottom: 1px solid rgba(217, 217, 217, 0.5);">
                                                        <ul class="product-detail">
                                                            <li>{{ $OrderProducts->product->name }}</li>
                                                            <li>QTY: <span>{{ $OrderProducts->quantity }}</span></li>
                                                            <li>Price: <span>${{ $OrderProducts->product->final_sell_price * $OrderProducts->quantity }}</span></li>
                                                        </ul>
                                                    </td>
                                                </tr>
                                            @endforeach
                    ...
                    <table class="text-center footer-table" align="center" border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            <td>
                                <table border="0" cellpadding="0" cellspacing="0" class="footer-social-icon text-center"
                                    ...
                                    <tr>
                                        <td style="font-size: 19px; font-weight: 700;">Shop For <span
                                                class="theme-color">StyleBrix</span></td>
                                    </tr>
                                </table>
                                {{-- <table border="0" cellpadding="0" cellspacing="0" class="footer-social-icon text-center"
                                    align="center" style="margin: 8px auto 20px;">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="www.facebook.com">
                                                <img src="https://stagging-stylebrix.s3.ap-south-1.amazonaws.com/logo/fb.png"
                                        ...
                                        <td>
                                            <a href="www.twitter.com">
                                                <img src="https://stagging-stylebrix.s3.ap-south-1.amazonaws.com/logo/twitter.png"
                                                    style="font-size: 25px; margin: 0 18px 0 0;width: 22px;filter: invert(1);"
                                                    alt="">
                                            </a>
                                        </td>
                                        <td>
                                            <a href="www.instagram.com">
                                                <img src="https://stagging-stylebrix.s3.ap-south-1.amazonaws.com/logo/insta.png"
                                                    style="font-size: 25px; margin: 0 18px 0 0;width: 22px;filter: invert(1);"
                                                    alt="">
                                            </a>
                                        </td>
                                        <td>
                                            <a href="www.pinterest.com">
                                                <img src="https://stagging-stylebrix.s3.ap-south-1.amazonaws.com/logo/pinterest.png"
                                                    style="font-size: 25px; margin: 0 18px 0 0;width: 22px;filter: invert(1);"
                                                    alt="">
                                            </a>
                                        </td>
                                ...
                                letter-spacing:1px; font-weight: 500;">© 2023 StyleBrix. All Rights Reserved.</h5>
                                        </td>
                                    </tr>
                                </table>
                            </td>
